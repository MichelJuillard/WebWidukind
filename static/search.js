...
var FrequencyFacets = React.createClass({
				displayName: "FrequencyFacets",

				getInitialState: function () {
								return { data: [{ id: "Year", code: "a", selected: false }, { id: "Semester", code: "h", selected: false }, { id: "Quarter", code: "q", selected: false }, { id: "Month", code: "m", selected: false }, { id: "Week", code: "w", selected: false }, { id: "Day", code: "d", selected: false }] };
				},
...
var ProvidersFacets = React.createClass({
				...
				componentWillMount: function (props) {
								$.get(widukind_root + '/provider_facets', { 'code': this.props.code }, (function (data) {
												if (this.isMounted()) {
...
var Dimension = React.createClass({
				...
				render: function () {
								...
								return React.createElement(
												...
												React.createElement(
																"li",
																{ onClick: this.handleOnClick.bind(this, this.props.id) },
																this.props.name
												),
												codes
								);
...
var TreeNode = React.createClass({
				...
				render: function () {
								...
								return React.createElement(
												"li",
												{ ref: "node", className: classes, key: this.props.key,
...
var DatasetFacets = React.createClass({
				...
				componentDidMount: function (props) {
								$.get(widukind_root + '/dataset_facets', { 'provider': this.props.provider, 'code': this.props.code }, (function (data) {
												if (this.isMounted()) {
																this.setState({ data: JSON.parse(data) });
												}
								}).bind(this));
...
var ButtonDatasetInfos = React.createClass({
				displayName: "ButtonDatasetInfos",
				...
				handleButtonDatasetInfo: function (e) {
								e.preventDefault();
								$.get(widukind_root + '/dataset_info', { 'code': this.props.code.toLowerCase() }, (function (data) {
				...
				render: function () {
								return React.createElement(
												"button",
												{ className: "btn btn-info", onClick: this.handleButtonDatasetInfo },
												"Infos"
								);
				}
});
...
var ButtonDatasetDownload = React.createClass({
				displayName: "ButtonDatasetDownload",
				...
				render: function () {
								return React.createElement(
												"button",
												{ className: "btn btn-download", onClick: this.handleButtonDatasetDownload, title: "Download" },
												"CSV"
								);
				}
});
...
var ButtonSeriesDownload = React.createClass({
				displayName: "ButtonSeriesDownload",
				...
				render: function () {
								return React.createElement(
												"button",
												{ className: "btn btn-download", onClick: this.handleButtonSeriesDownload, title: "Download datas" },
												"CSV"
								);
				}
});
...
var ButtonSeriesPrint = React.createClass({
				...
				handleButtonSeriesPrint: function (e) {
								e.preventDefault();
								$.get(widukind_root + '/print_series', { 'key': this.props.code }, (function (html) {
				...
				render: function () {
								return React.createElement(
												"button",
												{ className: "btn btn-print", onClick: this.handleButtonSeriesPrint, title: "Print datas" },
												"Print"
								);
				}
});
...
var ButtonSeriesPlot = React.createClass({
				...
				handleButtonSeriesPlot: function (e) {
								e.preventDefault();
								$.get(widukind_root + '/plot_series', { 'key': this.props.code }, (function (html) {
												this.setState({ results: html });
								}).bind(this));
				},
				...
				render: function () {
								return React.createElement(
												"button",
												{ className: "btn btn-plot", onClick: this.handleButtonSeriesPlot, title: "See Plot" },
												"Plot"
								);
				}
});
												...
												return React.createElement(
																...
																React.createElement(
																				...
																				React.createElement(
																								...
																								React.createElement(
																												"button",
																												{ onClick: this.props.handleDatasetSeries.bind(null, self.props.provider.toLowerCase(), self.props.code.toLowerCase()), className: "link" },
																												" ",
																												this.props.name
																								)
																				),
																				...
																				React.createElement(
																								"td",
																								null,
																								React.createElement(ButtonDatasetInfos, { code: this.props.code })
																				),
																				React.createElement(
																								"td",
																								null,
																								React.createElement(ButtonDatasetDownload, { code: this.props.code })
																				)
																)
												);
								} else {
				...
				render: function () {
								...
								return React.createElement(
												...
												React.createElement(
																"td",
																null,
																React.createElement(ButtonSeriesPrint, { code: this.props.code })
												),
												React.createElement(
																"td",
																null,
																React.createElement(ButtonSeriesDownload, { code: this.props.code })
												),
												React.createElement(
																"td",
																null,
																React.createElement(ButtonSeriesPlot, { code: this.props.code })
												)
								);
				}
});
...
var SearchDatasetsResults = React.createClass({
				displayName: "SearchDatasetsResults",
...
var SearchSeriesResults = React.createClass({
				displayName: "SearchSeriesResults",

				render: function () {
								var self = this;
								var results = JSON.parse(this.props.results);
								var header;
								if (self.props.with_provider) header = React.createElement(
												"tr",
												null,
												React.createElement(
																"th",
								...
								);else header = React.createElement(
												"tr",
												null,
												React.createElement(
																"th",
...
var SearchFormDatasets = React.createClass({
				displayName: "SearchFormDatasets",
...
var SearchFormDatasetSeries = React.createClass({
				displayName: "SearchFormDatasetSeries",
...
var WidukindSearchDatasets = React.createClass({
				displayName: "WidukindSearchDatasets",
				...
				render: function () {
								return React.createElement(
												"div",
												{ className: "wrapper search-datasets" },
												React.createElement(
																"div",
																{ id: "banner" },
																React.createElement(
																...
																React.createElement(
																				"p",
																				{ className: "lead" },
																				"A database of international macroeconomic data"
																)
												),
												React.createElement(
																"div",
...
var WidukindSearchSeries = React.createClass({
				displayName: "WidukindSearchSeries",
				...
				render: function () {
								return React.createElement(
												"div",
												{ className: "wrapper search-series" },
												React.createElement(
																"div",
																{ id: "banner" },
																React.createElement(
...
var WidukindSearchDatasetSeries = React.createClass({
				displayName: "WidukindSearchDatasetSeries",
				...
				render: function () {
								...
								return React.createElement(
												"div",
												{ className: "wrapper search-dataset-series" },
												React.createElement(
																"div",
																{ id: "banner" },
																React.createElement(
												...
												React.createElement(
																...
																React.createElement(
																				...
																				this.props.items.map(function (m, index) {
																								...
																								return React.createElement(
																												"li",
																												{ className: style, key: m, onClick: self.clicked.bind(self, index) },
																												m
																								);
																				})
																)
												...
												React.createElement(
																...
																React.createElement(
																				...
																				React.createElement(
																								...
																								React.createElement(
																												"li",
																												{ className: "logo logo-fs" },
																												React.createElement("img", { src: "static/logos/logo-fs.png", alt: "France Stratégie" })
																								),
																								React.createElement(
																												"li",
																												{ className: "logo logo-cepremap" },
																												React.createElement("img", { src: "static/logos/logo-cepremap.png", alt: "CEPREMAP" })
																								)
																				)
																)
												)
...
var Datasets = React.createClass({
				...
				render: function () {
								return React.createElement(WidukindSearchDatasets, { handleDatasetSeries: this.props.handleDatasetSeries });
				}
});

var DatasetSeries = React.createClass({
				displayName: "DatasetSeries",

				render: function () {
								return React.createElement(WidukindSearchDatasetSeries, { provider: this.props.provider, datasetCode: this.props.datasetCode });
				}
});
...
var Series = React.createClass({
				...
				render: function () {
								return React.createElement(WidukindSearchSeries, null);
				}
});
